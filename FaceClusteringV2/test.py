...
def extract_encoding_from_selfie(selfie_path):
    ...
    print(f"[INFO] Enconding extraído: {encodings[0]}")
    if len(encodings) == 0:
...
if __name__ == "__main__":
    selfie_path = "C:\\Users\\JadieldosSantos\\Desktop\\tcc-demo\\selfie_test\\pessoal-1.jpg"
    photos_folder = "C:\\Users\\JadieldosSantos\\Desktop\\tcc-demo\\selfie_test"
